...
//     private static SPAWN_COUNT: number = 0;    
...
//         sprite: Sprite,
//         button: RHButton,
//         labelledbutton: RHLabelledButton
//     }; 
...
//     public static createPrefabObjects(data: any, scene: BaseState): any {
//         if (scene === null) {
//             return;
//         }
//         if (data !== null) {
